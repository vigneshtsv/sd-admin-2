      ...
      <div id="content">
        <div className="container-fluid">
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">UseRef Hooks</h1>
          </div>
          <div>
          ...
          <div>
            Number of time component renders : {count.current}
          </div>
          <div>
            Enter your OTP:
          </div>
          <div>
            ...
            <input type='text' ref={ref4} onChange={()=>setTimeout(()=>{handleSubmit()
            },500)}/>
          </div>
        </div>
      </div>
